#  支付类漏洞挖掘技巧总结  
中铁13层打工人
                    中铁13层打工人  陌笙不太懂安全   2026-03-11 10:33  
...
```
作者:中铁13层打工人
原文链接:https://forum.butian.net/index.php/share/2778
```  
## 前言：  
...
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboQkFgpfJ2ict5SQXWgFiaibGiaTLr04icjzYgicKjRm0hyYYuB1b3b9lVhiaSxia7BWU1AQaCibmoV0Z9YrTtadq0pxN3ODtssRiaVH1G2oY/640?wx_fmt=png&from=appmsg "")  
#### 二、更改支付状态  
...
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboQbotgWloMHnibnXmfQBvVgADZJicvL3ALRoKZia17icJjTlxVrbp0n2l02U9zKPCib9r8A127Yc5Ck4AYYZM8xye14V1bcGUGT08ps/640?wx_fmt=png&from=appmsg "")  
#### 四、更改订单信息  
...
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboQzwZKibDbTcQVIlesicWic1Dup4N3eiagYuDR7sWXdc8wBRhW7TwIaB7QsXBq6rT4hIWQr4ic0fsH03ibutFr9ZmhI8jeAF5pG1KFGU/640?wx_fmt=png&from=appmsg "")  
  
2、修改订单号  
  
将金额不同的订单进行替换，可以支付一个金额较少的订单，然后将订单号修改为金额较大的订单，少付实际金额。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboQElQJuOOlOZ23b3D8BiaRa84WzEQjhAOXsHiaAMChdTwiaW1MpC7zibLFOMwHWBoylqALHRKaT4g1QTEXJPHFbOZsmfBZqoD26yXw/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboQULcctFSsnz40O0Ta4icU3woAMq6A2mJTNA4OUhZIDf8qdyZqic70iaBNGftjsziaUd9bRvjjiaA6zsoPrWgCVVRZibBLrJlib8rHykY/640?wx_fmt=png&from=appmsg "")  
  
2、未对负数做检验的还可以将数量改为负数。（这里需要注意，因为后端大部分会校验不允许实付金额小于0或者0.01等，所以有的时候要想实现订单成功生成需要结合实际修改价格）  
  
生成订单时有参数表示商品数量，修改为-1  
  
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboR3SK97ibWwRKnTlHRQL7tMmRiaLRH7TP7Pw5LfeIEWjhMj5Xgriby6OYFJSqibGMDxYJ95KibtVapicLvpu6JEEJJNSnacsP5YgguTg/640?wx_fmt=png&from=appmsg "")  
  
修改数量为-1后会发现，此时金额为负数。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboT2MWEoXZ6WcnpDLclynTMwuEYcXRrXYxNxYblwXVoXIQyeI7KIEiaDArgnbWR7vChXC8CLctjjzMSibuRe0aVU2MEPeocaalVwk/640?wx_fmt=png&from=appmsg "")  
  
在提交订单支付的时候，为保证支付成功需要修改金额。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboTh115w0cRHJd7sy1ymuze3qvpx4jDZ0nNpyaSKPZBqRIwljpH3ASpPicumD0JgYia8TaRrSgjJ15UHgicQo270knPed8FwAIjAJA/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboTxz689WQtExStZbho6dS81GbmHl7raxHc4qic9nkE9bo6ibYGbTImfoaLkf2R8gVgHsGQSId43dmqpfS3nwCFyfuUays4Wusxrw/640?wx_fmt=png&from=appmsg "")  
  
4、手动增加订单中商品相关的多个参数以达到少付多买的目的。  
  
有的时候在提交订单时抓取数据包可以看到只有一套商品的信息，尝试多添加几套同样的参数订单是否会有变化。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboQkTuicSpYhBHaMQTiaHCMH9qrU8bn6rShDpIcZzakiciaZsGD0ViblHPIWfFk58We9yiaEQ7yDSNaibmWpmpNGUcvAiawkS5X4QQias8sA/640?wx_fmt=png&from=appmsg "")  
  
尝试在提交订单的时候多添加几个此类参数  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboQaN5Dibf04u3b04rtqqOMmwxofcF1AwkfRavBeeSCCEcXZXNibx4lFma4E0HibSrfmomlkdd366ibCGOV06RibVlSQ16hQhgyesJF4/640?wx_fmt=png&from=appmsg "")  
  
提交订单实际支付金额未变仍是一个商品的价格，但是实际套餐已经变成了四个。  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboSicibScJ0dqt87GYtTiaulLfu0vIf2kbX4pf414nkicqCRAx4abibmUeftFZkFkAjBx5tLFKjhtXvmjCUWs6n9J4sHj7flNGXL2GlM/640?wx_fmt=png&from=appmsg "")  
#### 六、重复支付，突破限购  
...
![](https://mmbiz.qpic.cn/mmbiz_png/MSDUaqtwboSuV74Vian44TTImaqVMibCAPnSTYicy5K7bcka1LADEZP7Ix8WNLEyBbxEv4Tm1Wevl3hgh4uQj65xiauiamz5LRO94raltRmOZDIw/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/MSDUaqtwboSU3gicBVpRF5Qd3qQ92MsLYySugULtazKdiaC7gqzwSickIBLqfIYia1fsJp8G9EouFWmnDh9CoHHzgY7cwrs53qc9h9xuuOX5c0c/640?wx_fmt=png&from=appmsg "")  
#### 九、利用小数点精度四舍五入  

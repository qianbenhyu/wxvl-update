#  漏洞复现 | 用友NC OAContactsFuzzySearchServlet 反序列化代码执行RCE漏洞  
 实战安全研究   2026-03-13 01:00  
...
用友NC的OAContactsFuzzySearchServlet组件存在反序列化漏洞。该Servlet在处理用户请求时，可能对接收到的序列化数据（如Java的ObjectInputStream）未进行安全检查，直接进行反序列化操作。攻击者可以构造恶意的序列化对象，其中包含可执行的代码，当OAContactsFuzzySearchServlet反序列化该恶意对象时，就会触发代码执行。该漏洞可能允许攻击者在服务器上执行任意代码，从而完全控制服务器，窃取敏感数据，篡改系统配置，或进行其他恶意活动，对企业的业务系统和数据安全构成严重威胁。  
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/yIciaKAicYtoqkW98do6M09d9pr5UiaVW4zUpvhsdrR0Np3SubXiasPhY66jnsSKA9cxSBJpoa4asCzficHfcuW3xyZcBQru4b8bpsRewic2kptkk/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/yIciaKAicYtooc7DwJKmmfkNNB4Xib1x8YIpCXTe3fFrofvkPkHbwV7SJcPDJAMlgmpzecicicEmpCicaz1ibdDLRkZuzPFnWVQozS1nnLRtUWNIjA/640?wx_fmt=png&from=appmsg "")  
  
afrog  
  
![](https://mmbiz.qpic.cn/sz_mmbiz_png/yIciaKAicYtoqNHcWEyW0e67FjBfMuEibO9zeqia4cpPYr8u5R2W134UJsQ8lAJjGGzWn3ia1dOpbdE853Sb9xrNoatJN15iaUOMGarWicW53H5r7I/640?wx_fmt=png&from=appmsg "")  

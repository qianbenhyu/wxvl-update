#  【在野利用】青龙面板未授权命令注入漏洞  
原创 360漏洞研究院
                    360漏洞研究院  360漏洞研究院   2026-03-03 02:58  
...
青龙面板是一个功能强大的定时任务管理平台，它支持 Python3、JavaScript、Shell、TypeScript 等多种脚本语言，非常适合用来管理和运行各类自动化脚本。  
...
近日，360漏洞研究院捕获到青龙面板中存在的鉴权绕过导致命令注入漏洞。攻击者可通过路径大小写混淆的方式绕过认证机制，成功访问高权限接口，进而**执行远程命令**  
。  
...
360漏洞研究院已复现青龙面板未授权命令注入漏洞，并验证该漏洞可导致远程命令执行。  
  
![](https://mmbiz.qpic.cn/mmbiz_png/dZ7ia5iaWFzz8bR6ASOu3JwnpDUS502Oqib2MQrC70LaZak6y1aDEquKWMTmybDiadsKOBOFPcLUR7TRQs2ibdU4tQy9DM4licFYZTLNicqFzhIibMs/640?wx_fmt=png&from=appmsg "")  
...
**360高级持续性威胁预警系统**  
：预计 2026年03月04日发布规则更新包，支持该漏洞利用行为的检测。  

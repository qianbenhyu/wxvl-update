...
**谷歌已为其Chrome浏览器发布紧急安全更新**  
，此前确认两个高严重性零日漏洞正在野外被积极利用。  
## 更新版本信息  
- **Windows和macOS平台**  
：146.0.7680.75/76版本  
- **Linux平台**  
...
- **漏洞位置**  
：V8（Chrome的高性能JavaScript和WebAssembly引擎）  
- **风险等级**  
：高严重性  
- **技术影响**  
：  
...
## 重要安全声明  
- **漏洞发现时间**  
：2026年3月10日（由谷歌安全团队内部报告）  
- **当前状态**  
：谷歌已**明确确认**  
这两个漏洞的利用代码已在野外存在  
- **技术细节限制**  
：相关技术细节和错误跟踪条目将保持限制，直到相当一部分用户应用补丁，以防止进一步利用  
## 紧急缓解措施  
### 个人用户操作指南  
1. **手动触发更新**  
：  
1. 打开Chrome并导航至 **菜单 → 帮助 → 关于Google Chrome**  
1. Chrome将**自动检查并应用**  
最新更新  
1. **重启浏览器**  
以完成安装  
